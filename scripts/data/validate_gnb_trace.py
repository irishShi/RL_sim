...
def main():
    ...
    parser.add_argument("--xlsx", type=str, default="data/raw/real/nr_gnb_rsrp_sinr_km.xlsx")
    parser.add_argument("--model", type=str, default="experiments/runs/legacy_20260416_offline_rainbow/checkpoints/rainbow_offline_final.pth")
    ...
    if args.save_csv:
        out_csv = os.path.join(project_root, "data", "processed", "real", "gnb_trace_processed.csv")
