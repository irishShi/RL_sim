...
def main():
    ...
    for episode in range(max_episodes):
        ...
        # 定期保存模型
        if (episode + 1) % 50 == 0:
            save_dir = os.path.join(base_dir, "experiments", "runs", "online_rainbow_latest", "checkpoints")
    ...
    # 10. 保存最终模型
    final_save_path = os.path.join(base_dir, "experiments", "runs", "online_rainbow_latest", "checkpoints", "rainbow_final.pth")
